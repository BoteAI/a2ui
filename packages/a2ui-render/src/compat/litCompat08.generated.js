...
function isAsciiTrimmable(c8) {
  return c8 === 32 || c8 === 9 || c8 === 10 || c8 === 13;
}
...
function applyReplacements(str, replacements) {
  ...
  for (let i11 = 0; i11 < replacements.length; i11++) {
    const replacement = replacements[i11];
  ...
  for (let i11 = 0; i11 < tokens.length; i11++) {
    ...
    OUTER:
      while (pos < max) {
        ...
        if (!canOpen && !canClose) {
          if (isSingle) {
            addReplacement(replacements, i11, t7.index, APOSTROPHE);
          }
          continue;
        }
        if (canClose) {
          for (j2 = stack.length - 1; j2 >= 0; j2--) {
            ...
            if (item.single === isSingle && stack[j2].level === thisLevel) {
              ...
              addReplacement(replacements, i11, t7.index, closeQuote);
...
function html_block(state, startLine, endLine, silent) {
  ...
  let nextLine = startLine + 1;
  const endsOnBlankLine = HTML_SEQUENCES[i11][1].test("");
...
var init_linkify_it = __esm({
  "../../node_modules/linkify-it/index.mjs"() {
    ...
    LinkifyIt.prototype.test = function test(text3) {
      ...
      if (this.re.schema_test.test(text3)) {
        ...
        while ((m5 = re.exec(text3)) !== null) {
          if (this.testSchemaAt(text3, m5[2], re.lastIndex)) {
            return true;
          }
        }
      }
      ...
      if (this.re.schema_test.test(text3)) {
        ...
        while ((m5 = re.exec(text3)) !== null) {
          ...
          if (len) {
            type_schemed.push({
              schema: m5[2],
              index: m5.index + m5[1].length,
              lastIndex: m5.index + m5[0].length + len
            });
          }
        }
      }
      if (this.__opts__.fuzzyLink && this.__compiled__["http:"]) {
        ...
        while ((m5 = re.exec(text3)) !== null) {
          type_fuzzy_link.push({
            schema: "",
            index: m5.index + m5[1].length,
            lastIndex: m5.index + m5[0].length
          });
        }
      }
      if (this.__opts__.fuzzyEmail && this.__compiled__["mailto:"]) {
    ...
    LinkifyIt.prototype.matchAtStart = function matchAtStart(text3) {
      ...
      if (!len) return null;
      const match2 = new Match(text3, m5[2], m5.index + m5[1].length, m5.index + m5[0].length + len);
      this.__compiled__[match2.schema].normalize(match2, this);
      return match2;
    };
...
function _arrayLikeToArray(r9, a4) {
  (null == a4 || a4 > r9.length) && (a4 = r9.length);
  for (var e11 = 0, n11 = Array(a4); e11 < a4; e11++) n11[e11] = r9[e11];
  return n11;
}
...
function _iterableToArrayLimit(r9, l5) {
  ...
  if (null != t7) {
    var e11, n11, i11, u5, a4 = [], f4 = true, o13 = false;
    try {
      if (i11 = (t7 = t7.call(r9)).next, 0 === l5) ;
      else for (; !(f4 = (e11 = i11.call(t7)).done) && (a4.push(e11.value), a4.length !== l5); f4 = true) ;
    } catch (r10) {
      o13 = true, n11 = r10;
    } finally {
      try {
        if (!f4 && null != t7.return && (u5 = t7.return(), Object(u5) !== u5)) return;
      } finally {
        if (o13) throw n11;
      }
    }
...
function _unsupportedIterableToArray(r9, a4) {
  if (r9) {
    if ("string" == typeof r9) return _arrayLikeToArray(r9, a4);
    var t7 = {}.toString.call(r9).slice(8, -1);
    return "Object" === t7 && r9.constructor && (t7 = r9.constructor.name), "Map" === t7 || "Set" === t7 ? Array.from(r9) : "Arguments" === t7 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t7) ? _arrayLikeToArray(r9, a4) : void 0;
  }
}
...
function createDOMPurify() {
  ...
  DOMPurify.sanitize = function(dirty) {
    ...
    if (RETURN_DOM) {
      if (SAFE_FOR_TEMPLATES) {
        _scrubTemplateExpressions(body2);
      }
      if (RETURN_DOM_FRAGMENT) {
...
var entries, setPrototypeOf, isFrozen, getPrototypeOf, getOwnPropertyDescriptor, freeze, seal, create2, _ref, apply, construct, arrayForEach, arrayLastIndexOf, arrayPop, arrayPush, arraySplice, arrayIsArray, stringToLowerCase, stringToString, stringMatch, stringReplace, stringIndexOf, stringTrim, numberToString, booleanToString, bigintToString, symbolToString, objectHasOwnProperty, objectToString, regExpTest, typeErrorCreate, html$1, svg$1, svgFilters, svgDisallowed, mathMl$1, mathMlDisallowed, text2, html, svg, mathMl, xml, MUSTACHE_EXPR, ERB_EXPR, TMPLIT_EXPR, DATA_ATTR, ARIA_ATTR, IS_ALLOWED_URI, IS_SCRIPT_OR_DATA, ATTR_WHITESPACE, DOCTYPE_NAME, CUSTOM_ELEMENT, NODE_TYPE, getGlobal, _createTrustedTypesPolicy, _createHooksMap, purify;
...
var n9 = e7(class extends f3 {
  ...
  update(i11, [s11]) {
    ...
    return e11 && this.rt(void 0), (e11 || this.lt !== this.ct) && (this.G = s11, this.ht = (_a7 = i11.options) == null ? void 0 : _a7.host, this.rt(this.ct = i11.element)), A;
  }
  rt(t7) {
    var _a7;
