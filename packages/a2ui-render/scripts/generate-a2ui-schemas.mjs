/**
 * 根据 a2ui-schema.config.mjs 的 schema 段写出 *.schema.json
 */
...
export async function generateA2uiSchemas(root, userConfig) {
  ...
  const outdir = schemaConfig.outdir ?? 'src/presetComp/schemas';
...
if (isDirectRun) {
  ...
  const configPath = path.join(root, 'a2ui-schema.config.mjs');
